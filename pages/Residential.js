        ...
        <>
            <Layout>
                    ...
                    <div className="   banner-howitwork   ">
                        <div className="container">
                            <div className="box-info-trackyourparcel"><img className="mb-1 wow animate__animated animate__fadeIn" src="/img/bear.png.png"style={{height:'60px'}} alt="transp" />
                                <h2 className="color-mb-5 wow animate__animated animate__fadeIn"style={{color:'black'}}>BinBear Full-Service Junk Removal: Texas’ #1 Junk Company</h2>
                ...
                <section className="section mt-0">
                    ...
                    <div className="container">
                        <div className="row align-items-center">
                            <div className="col-lg-6 mb-0"><img className="mb-wow animate__animated animate__fadeIn" src="/assets/imgs/page/workprocess/parachute.png" alt="transp" />
                               ...
                               <p className="font-md color-grey-700 wow animate__animated animate__fadeIn"style={{marginTop:'0px',height:'20px'}}></p>
                               
                               </div>
                            <div className="col-lg-6 mb-0"><Link className="wow animate__animated animate__fadeIn" href="#"><img src="/assets/imgs/page/service-detail/img4.png" alt="transp" /></Link></div>
                        </div>
...
color:orange;}
                                       ...
                                       <div className="item-reason wow animate__animated animate__fadeIn">
                                           <div className="card-offer cardServiceStyle3 hover-up">
                                               ...
                                               <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 60 75" height="120">
  <path d="M43.075,20.519l1.21-7a2.944,2.944,0,0,0-.495-2.217,3,3,0,0,0-5.083.257L34.8,4.768a5.544,5.544,0,0,0-9.6,0L17.285,18.528A2.984,2.984,0,0,0,19.872,23a3.014,3.014,0,0,0,2.614-1.505L30,8.443l4.35,7.55-.771-.133a3,3,0,0,0-2.254.51,2.98,2.98,0,0,0,1.237,5.371l7.042,1.21A3.027,3.027,0,0,0,43.075,20.519Zm-3.126.462l-7.056-1.212A.981.981,0,0,1,32.482,18a1.017,1.017,0,0,1,.758-.171l2.87.5a1,1,0,0,0,1.036-1.484L31.319,6.728a1.562,1.562,0,0,0-2.645.011l-7.92,13.755a1.01,1.01,0,0,1-1.37.375.979.979,0,0,1-.466-.6.965.965,0,0,1,.1-.743l7.92-13.77a3.544,3.544,0,0,1,6.124,0l5.161,8.973a1,1,0,0,0,1.852-.328l.271-1.556a.989.989,0,0,1,.412-.648.97.97,0,0,1,.742-.157,1,1,0,0,1,.654.411.961.961,0,0,1,.161.723v0l-1.209,6.993A.966.966,0,0,1,39.949,20.981Z" fill="orange"/>
  <path d="M51.3,31.016a3.006,3.006,0,0,0-4.091-1.094,2.988,2.988,0,0,0-1.1,4.1L53.613,47H45.882a2.994,2.994,0,0,0-.107-4.1,3.016,3.016,0,0,0-4.245-.028l-5.063,5a3.015,3.015,0,0,0,.005,4.269l5.055,4.986A2.979,2.979,0,0,0,43.644,58a3.029,3.029,0,0,0,2.131-.887,3,3,0,0,0,.1-4.113h8.59a5.476,5.476,0,0,0,4.8-2.76,5.4,5.4,0,0,0-.011-5.481Zm6.23,18.223h0A3.5,3.5,0,0,1,54.464,51H43.454a1,1,0,0,0-.7,1.709l1.6,1.588a.98.98,0,0,1,.3.7.992.992,0,0,1-.287.711,1.031,1.031,0,0,1-1.42,0l-5.055-4.985a1.015,1.015,0,0,1-.3-.723,1,1,0,0,1,.293-.709L42.932,44.3a1.016,1.016,0,0,1,.71-.289,1,1,0,0,1,.7,1.711l-1.59,1.57a1,1,0,0,0,.7,1.712h11.01a1.477,1.477,0,0,0,1.332-.771,1.438,1.438,0,0,0-.007-1.46L47.838,33.016a.985.985,0,0,1,.367-1.361,1,1,0,0,1,1.363.366L57.52,45.763A3.428,3.428,0,0,1,57.528,49.239Z" fill="orange"/>
  <path d="M5.535,53H18.881a3,3,0,0,0,0-6H6.386l3.8-6.569A3,3,0,0,0,15.9,38.66L14.2,31.8a2.982,2.982,0,0,0-1.358-1.857A2.944,2.944,0,0,0,10.6,29.6l-6.96,1.679a3,3,0,0,0-2.2,3.618A3.024,3.024,0,0,0,5.05,37.112l.141-.035L.753,44.754a5.406,5.406,0,0,0-.011,5.488A5.488,5.488,0,0,0,5.535,53ZM2.481,45.761l5.609-9.7a1,1,0,0,0-.865-1.5.986.986,0,0,0-.235.027l-2.4.579a1.016,1.016,0,0,1-1.21-.742,1,1,0,0,1,.731-1.2l6.963-1.681a.973.973,0,0,1,.736.116,1,1,0,0,1,.454.623l1.7,6.857a1,1,0,0,1-1.937.482l-.509-2.051a1,1,0,0,0-.831-.749.991.991,0,0,0-1.006.491l-5.46,9.447a1.412,1.412,0,0,0-.036,1.431A1.494,1.494,0,0,0,5.535,49H18.881a1,1,0,0,1,0,2H5.535a3.506,3.506,0,0,1-3.061-1.758A3.43,3.43,0,0,1,2.481,45.761Z" fill="orange"/>
  <path d="M30,24A11,11,0,1,0,41,35,11.013,11.013,0,0,0,30,24Zm0,20a9,9,0,1,1,9-9A9.01,9.01,0,0,1,30,44Z" fill="orange"/>
  <path d="M33.447,30.105a1,1,0,0,0-1.342.448l-3.379,6.759-1.019-1.019a1,1,0,0,0-1.414,1.414l2,2A1,1,0,0,0,29,40a.968.968,0,0,0,.16-.013,1,1,0,0,0,.735-.54l4-8A1,1,0,0,0,33.447,30.105Z" fill="orange"/>
  <text x="0" y="75" fill="orange" font-size="5px" font-weight="bold"></text>
  <text x="0" y="80" fill="orange" font-size="5px" font-weight="bold"></text>
</svg>
